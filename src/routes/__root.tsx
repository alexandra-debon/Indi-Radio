...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Écoute Indi Radio en direct. Plus qu’une radio. Découvre les artistes indé, participe au mur social, retrouve l'historique des titres passés à l'antenne et +." },
      ...
      { name: "twitter:description", content: "Écoute Indi Radio en direct. Plus qu’une radio. Découvre les artistes indé, participe au mur social, retrouve l'historique des titres passés à l'antenne et +." },
