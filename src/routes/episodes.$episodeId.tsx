  ...
  head: async ({ params, loaderData, match }) => {
    ...
    return {
      meta: [
        ...
        ...ogLocaleTags(lang),
        ...ogImageTags(image, { baseUrl: BASE_URL, alt: ep.title }),
