...
export const Route = createFileRoute("/actus/")({
  head: async ({ match }) => ({
    meta: await localizedStaticMeta("/actus", match.search, [
      { title: "Blog InDi ArT CulTuRe — Radio 24/7 de la musique indépendante InDi RaDio" },
      { name: "description", content: "Le Blog InDi ArT CulTuRe : articles, dossiers et actus de la scène indépendante et du réseau social musique, sur la radio 24/7 de la musique indépendante." },
      { name: "keywords", content: "blog musique indépendante, InDi ArT CulTuRe, radio musique indé, réseau social musique, radio musique indépendante, InDi RaDio" },
      { property: "og:title", content: "Blog InDi ArT CulTuRe — Radio 24/7 de la musique indépendante InDi RaDio" },
      { property: "og:description", content: "Le Blog InDi ArT CulTuRe : articles, dossiers et actus de la scène indépendante et du réseau social musique, sur la radio 24/7 de la musique indépendante." },
      { name: "twitter:title", content: "Blog InDi ArT CulTuRe — Radio 24/7 de la musique indépendante InDi RaDio" },
      { name: "twitter:description", content: "Le Blog InDi ArT CulTuRe : articles, dossiers et actus de la scène indépendante et du réseau social musique, sur la radio 24/7 de la musique indépendante." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Blog InDi ArT CulTuRe",
          description: "Le blog d'InDi ArT CulTuRe : articles, dossiers et actus des artistes indépendants, orchestrés par la rédaction d'InDi RaDio.",
